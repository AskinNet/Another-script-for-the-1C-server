...
Функция ПолучениеСоединенийСКластером()
	...
	Попытка
		...
		Управление = Новый УправлениеКластером1С("8.3", ИмяСервераRAS, Админ);
...
Процедура ПерезапускСервера()
	...
	Лог.Отладка("Очистка каталога сеансовых данных сервера 1с");
